...
def generate_graph(data):
    ...
    fig.update_traces(market_color="#008c41")
...
class ExpenseListView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        aggregated_data = [{ 'year_month': key, 'expenses': sum(item['amount'] for item in 
        value)} for key, value in expense_data_graph.items()]
